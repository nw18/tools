...
public class Mime {
	...
	static {
		String mimeList[] = new String[] { "ipa:application/octet-stream", "plist:text/xml",
				...
				"oda:application/oda", "pdf:application/pdf", "ai:application/postscript", "eps:application/postscript",
				"ps:application/postscript", "smi:application/smil", "smil:application/smil", "mif:application/vnd.mif",
				"xls:application/vnd.ms-excel", "ppt:application/vnd.ms-powerpoint", "wbxml:application/vnd.wap.wbxml",
				"wmlc:application/vnd.wap.wmlc", "wmlsc:application/vnd.wap.wmlscriptc", "bcpio:application/x-bcpio",
				"vcd:application/x-cdlink", "pgn:application/x-chess-pgn", "cpio:application/x-cpio",
				"csh:application/x-csh", "dcr:application/x-director", "dir:application/x-director",
				"dxr:application/x-director", "dvi:application/x-dvi", "spl:application/x-futuresplash",
				"gtar:application/x-gtar", "hdf:application/x-hdf", "js:application/x-javascript",
				...
				"zip:application/zip", "au:audio/basic", "snd:audio/basic", "mid:audio/midi", "midi:audio/midi",
				"kar:audio/midi", "mpga:audio/mpeg", "mp2:audio/mpeg", "mp3:audio/mpeg", "aif:audio/x-aiff",
				...
				"xpm:image/x-xpixmap", "xwd:image/x-xwindowdump", "igs:model/iges", "iges:model/iges", "msh:model/mesh",
				"mesh:model/mesh", "silo:model/mesh", "wrl:model/vrml", "vrml:model/vrml", "css:text/css",
				"html:text/html", "htm:text/html", "asc:text/plain", "txt:text/plain", "rtx:text/richtext",
				"rtf:text/rtf", "sgml:text/sgml", "sgm:text/sgml", "tsv:text/tab-separated-values",
				"wml:text/vnd.wap.wml", "wmls:text/vnd.wap.wmlscript", "etx:text/x-setext", "xsl:text/xml",
				"xml:text/xml", "mpeg:video/mpeg", "mpg:video/mpeg", "mpe:video/mpeg", "qt:video/quicktime",
				"mov:video/quicktime", "mxu:video/vnd.mpegurl", "avi:video/x-msvideo", "movie:video/x-sgi-movie",
				"ice:x-conference/x-cooltalk" };
		for(String mp : mimeList){
			String ma[] = mp.split(":");
			mimeMap.put(ma[0], ma[1]);
		}
	}
	
	public static String toContentType(String fileExt){
